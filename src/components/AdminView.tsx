          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-black/20 p-4 rounded-xl border border-white/5 overflow-x-auto">
                <pre className="text-sm font-mono whitespace-pre-wrap break-words text-on-surface">
                  {item.originalData ? JSON.stringify(item.originalData, null, 2) : 'No content available'}
                </pre>
              </div>
            </div>
          </div>
