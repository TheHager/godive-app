...
export const RANKS: Rank[] = [
  ...
  { min: 50, title: "Leviathan's Peer", status: "Mythic", nextGoal: "Oceanic Oracle", cert: "Technical Trimix Diver", desc: "The ocean no longer feels like a visit; it feels like home." },
  { min: 65, title: "Oceanic Oracle", status: "Legend", nextGoal: "Soul of the Sea", cert: "Full Cave Diver", desc: "Possesses knowledge of the deep that few can comprehend." },
  { min: 80, title: "Soul of the Sea", status: "Immortal", nextGoal: "The Blue Eternal", cert: "Expedition Leader", desc: "The boundary between human and water has vanished." },
  { min: 100, title: "The Blue Eternal", status: "Deity", nextGoal: "None", cert: "Master Explorer", desc: "The ultimate guardian of the world beneath the waves." },
];
